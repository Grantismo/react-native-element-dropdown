...
const DropdownComponent = /*#__PURE__*/_react.default.forwardRef((props, currentRef) => {
  ...
  const _renderDropdown = () => {
    ...
    return /*#__PURE__*/_react.default.createElement(_reactNative.TouchableWithoutFeedback, {
      ...
      onPress: showOrClose
    }, /*#__PURE__*/_react.default.createElement(DropdownView, null, renderLeftIcon === null || renderLeftIcon === void 0 ? void 0 : renderLeftIcon(visible), /*#__PURE__*/_react.default.createElement(_reactNative.Text, _extends({
    ...
    if (search) {
      if (renderInputSearch) {
        ...
        return /*#__PURE__*/_react.default.createElement(_TextInput.default, {
          ...
          style: [_styles.styles.input, inputSearchContainerStyle],
  ...
  const _renderModal = (0, _react.useCallback)(() => {
    if (visible && position) {
      ...
      if (width && top && bottom) {
        ...
        }, /*#__PURE__*/_react.default.createElement(ContainerView, null, _renderList(isTopPosition))));
      }
      return null;
    }
    return null;
